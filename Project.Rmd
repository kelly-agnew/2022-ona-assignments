...
stargazer(lm1, lm2, 
          ...
          covariate.labels= c("Degree Centrality", "Eigenvector Centrality", "Betweenness Centrality", "Tenure (days)", "Male", "Hispanic", "White", "Work Group 219", "Degree:Male", "Eigenvector:Male", "Betweenness:Male"),
          digits = 2)
